const body = document.querySelector('body'),
      ...
      activeme = body.querySelector(".activeme");
...
activeme.addEventListener("click" , () =>{
    body.classList.toggle("active");
    // if(body.classList.contains("activeme")){
    //     activeme.innerText = "Light mode";
    // }else{
    //     activeme.innerText = "Dark mode";
...
function addStudent(event){
    ...
    .then((result) => {
        if (result.isConfirmed) {
            document.getElementById('student-add-form').submit();
      }
    });
    
}
// USE SWEET ALERT TO SUBMIT FORM {{VENUE}}
function addVenue(event){
    event.preventDefault();
        Swal.fire({
        title: 'Do you want to Add Venue?',
        text: 'You can edit This Later',
        icon:'warning',
        showDenyButton: true,
        showCancelButton: false,
    ...
    .then((result) => {
        if (result.isConfirmed) {
            document.getElementById('venue-add-form').submit();
      }
    });
}
// USE SWEET ALERT TO SUBMIT FORM {{SESSION}} 
function addSessionn(event){
    event.preventDefault();
        Swal.fire({
        title: 'Do you want to Add Session?',
        text: 'You can edit This Later',
        icon:'warning',
        showDenyButton: true,
        showCancelButton: false,
    ...
    .then((result) => {
        if (result.isConfirmed) {
            document.getElementById('session-add-form').submit();
      }
    });
}
...
// BLK4 -6.216523324209453 , 35.81369086025162
35.813683
35.747513
// bottomleft='-6.214079, 35.809560';
// topright='-6.213748, 35.809760';
bottomright='-6.214073, 35.809761';
