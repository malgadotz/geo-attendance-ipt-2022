...
<link rel="stylesheet" href="js/datatables.net-bs/css/dataTables.bootstrap.min.css">
  ...
  <link rel="shortcut icon" href="photo/ajiratz.ico" type="image/x-icon">
...
<div class="dashboard" style="position: fixed;width: 18%;height: 100%;background:#222D32">
  <div style="background:#357CA5;padding: 14px 3px;color:white;font-size: 15pt;text-align: center;text-shadow: 1px 1px 11px black">
    <a href="home.php" style="color: white;text-decoration: none;"><?php echo strtoupper(siteName()); ?> </a>
  </div>
  ...
  <div>
    ...
    <div class="item">
      <ul class="nostyle zero">
        <a href="home.php"><li ><i class="fa fa-circle-o fa-fw"></i> Home</li></a>
...
<script type="text/javascript">
 function addInBill(id,place)
 {
    ...
    var exp=document.getElementById("dataTable").rows[place].cells[4].innerHTML;
    var modToday=new Date(today);
    var modExp=new Date(exp);
   // var dt=dtf.format(ldt);
   // alert(dt);
    // var dd=new Date("2019-2-17");
     //alert(today);
    if((modToday.getFullYear()>modExp.getFullYear())||((modToday.getMonth())>modExp.getMonth())||((modToday.getDate())>modExp.getDate())){
      Swal.fire({
				position: 'top-end',
        type:"message",
        html:'<h4>Sorry Drug has expired<h/4>',
				title: 'Malaperi',
        dangerMode:true,
        text:'',
        icon: 'warning',
  ...
  function deelete()
 {
  ...
  Swal.fire({
    ...
    if(willDelete){
      ...
      Swal.fire('tdddext','error');
    }
    else{
      Swal.fire('text2','error');
    }
  });
