        ...
        <div class="col-md-8 offset-md-2">
            <div class="card">
                <div class="card-header">
                    <h2>{{ __('Update Session') }}</h2>
                </div>
                <div class="card-body">
                    <form method="POST" action="update">
                        @csrf
                        <input type="hidden" name="snid" value="{{$model->id}}">
                        <div class="row mb-3">
                            ...
                            <option :value="{{$model->activity_name}}">{{$model->activity_name}}</option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <option value="{{$venue->id}}">{{$venue->code}}</option>
                            ...
                            <div class="col-md-6">
                                <select id="course_id"  class="form-control" name="course_id" value="{{ old('course_id') }}" required>                      
                                    ...
                                    @foreach($courses as $course)    
                                        <option value="{{$course->course_id}}">{{App\Models\Course::find($course->course_id)->course_name}} {{App\Models\Course::find($course->course_id)->course_code}}</option>
                                    @endforeach
                                </select>
                                @error('course_id')
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select id="program_id"  class="form-control" name="program_id">                      
                                        <option value="{{$program->id}}"> {{$program->name}} {{App\Models\Program::find($program->id)->program_code}}</option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="date" type="date" class="form-control @error('date') is-invalid @enderror" name="date" value="{{$model->date}}" required autocomplete="date" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="start_time" type="time" class="form-control @error('start_time') is-invalid @enderror" name="start_time" value="{{$model->start_time}}" required autocomplete="start_time" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="end_time" type="time" class="form-control @error('end_time') is-invalid @enderror" name="end_time" value="{{$model->end_time}}" required autocomplete="identifier" autofocus>
