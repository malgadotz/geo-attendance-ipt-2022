            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" id="staff-form" action="{{ url('admin/staff/make') }}">
                        ...
                        <div class="row mb-3">
                            <label for="course_code" class="col-md-4 col-form-label text-md-end">{{ __('Email Address') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="course_code" class="col-md-4 col-form-label text-md-end">{{ __('Mobile Phone') }}</label>
