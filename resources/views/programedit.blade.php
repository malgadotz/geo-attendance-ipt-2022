                ...
                <div class="card-body">
                    <form method="POST" action="update">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="program_code" type="text" class="form-control @error('program_code') is-invalid @enderror" name="program_code" value="{{ $model->program_code}}" required autocomplete="program_code" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select id="years" type="text" class="form-control @error('years') is-invalid @enderror" name="years" value="{{ old('years') }}" required autocomplete="years" autofocus>                      
                                    ...
                                    <option value="{{$model->years}}">{{$model->years}}</option>
