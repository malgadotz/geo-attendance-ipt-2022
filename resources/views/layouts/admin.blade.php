                    ...
                    <ul class="navbar-nav mr-2 navbar-right">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                <a id="navbarDropdowno" class="nav-link dropdownoo-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                {{Auth::user()->username}}
                                </a>

                                <div class="dropdsown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
