        ...
        <header>
            <div class="image-text">
                ...
                <div class="text logo-text text-center">
                    ...
                    <span class="profession">{{ strtoupper(Auth::user()->name) }}</span>
                </div>
            </div>
...
<a href="{{url('staff/dashboard')}}">
    ...
    <nav class="navbar navbar-expand-lg navbar-light py-1 udom-light shadow-sm">
            <div class="container-fluid">
            <h6 class="text-center offset-md-4" >Students Attendence Management System (SAMS)</h6>
                    ...
                    <ul class="navbar-nav mr-2 navbar-right">
                        <!-- Authentication Links -->
                            ...
                            <li class="nav-item dropdown">
                                <a id="navbarDropdodwn" class="nav-link dropdocwn-toggle" href="#" onclick="logoutNow(event)" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                {{Auth::user()->username}} <i class='fas fa-power-off icon' ></i>
                                </a>

                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navdbarDropdown">
                                    <a class="dropdodwn-item" href="{{ route('logout') }}"
