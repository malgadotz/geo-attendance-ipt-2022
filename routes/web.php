...
// ADMIN
Route::get('admin/view',[AdminController::class,'view'])->name('admin.admin.view');
Route::get('admin/add',[AdminController::class,'add'])->name('admin.admin.add');
Route::post('admin/make',[AdminController::class,'create'])->name('admin.admin.create');
...
Route::post('admin/edit/update',[AdminController::class,'update'])->name('admin.admin.update');
...
Route::get('staffexport', [StaffController::class, 'exportstaff'])->name('admin.staff.exports');
...
Route::get('staffcourse/export', [StaffCourseController::class, 'exportstaffcourse'])->name('admin.staffcourse.exports');
...
Route::group(['prefix'=>'staff', 'middleware'=>['isStaff','auth']], function(){
    ...
    Route::get('program/view',[ProgramController::class,'view'])->name('staff.program.view');
// COURSE
    Route::get('staffcourse/view',[StaffCourseController::class,'staffview'])->name('staff.staffcourse.view');
// VENUE
    Route::get('venue/view',[VenueController::class,'view'])->name('staff.venue.view');
// SESSION
Route::get('session/view',[SessionController::class,'staffview'])->name('staff.session.view');
Route::get('session/add',[SessionController::class,'add'])->name('staff.session.add');
Route::post('session/create',[SessionController::class,'create'])->name('staff.session.create');

Route::get('session/delete/{id}',[SessionController::class,'delete'])->name('staff.session.delete');
Route::get('session/edit/{id}',[SessionController::class,'edit'])->name('staff.session.edit');
Route::post('session/edit/update',[SessionController::class,'update'])->name('staff.session.update');

// Notification
Route::get('sms/view',[StaffController::class,'sms'])->name('staff.sms.view');
Route::post('sms/create',[StaffController::class,'createsms'])->name('staff.sms.create');

// STUDENT
Route::get('student/view',[StudentController::class,'viewstaff'])->name('staff.student.view');

// ATTENDENCE
Route::get('attendence/view',[AttedenceController::class,'attendanceviewstaff'])->name('staff.attendence.view');
// Route::get('attendence/add',[AttedenceController::class,'add'])->name('staff.attendence.add');
// Route::get('attendence/add/{id}',[AttedenceController::class,'add'])->name('staff.attendence.adds');
// Route::post('attendence/create',[AttedenceController::class,'store'])->name('staff.attendence.create');

Route::get('attendence/export', [AttedenceController::class, 'exportstaff'])->name('staff.attendence.exports');



}
);
                            // STUDENT GROUP {USER.Role = STUDENT}
...
Route::group(['prefix'=>'student', 'middleware'=>['isStudent','auth']], function(){
    ...
    Route::post('sms/create',[UserProfileController::class,'nida'])->name('student.sms.create');
Route::get('qr/view',[StudentController::class,'qr'])->name('student.qr.view');
Route::post('qr/create',[UserProfileController::class,'qrcode'])->name('student.qrcode.create');


    Route::get('program/view',[ProgramController::class,'view'])->name('student.program.view');
    // Route::get('program/add',[ProgramController::class,'add'])->name('student.program.add');
    // Route::post('program/store',[ProgramController::class,'store'])->name('admin.program.store');
// COURSE
    Route::get('studentcourse/view',[StudentCourseController::class,'studentcourse'])->name('student.course.view');
    // Route::get('course/add',[CourseController::class,'add'])->name('admin.course.add');
    // Route::post('course/create',[CourseController::class,'create'])->name('admin.course.create');
// VENUE
    Route::get('venue/view',[VenueController::class,'view'])->name('student.venue.view');
    Route::get('venue/add',[VenueController::class,'add'])->name('student.venue.add');
    Route::post('venue/create',[VenueController::class,'create'])->name('student.venue.create');
// SESSION
Route::get('session/view/student',[SessionController::class,'sessionview'])->name('student.session.view');
Route::get('session/add',[SessionController::class,'add'])->name('student.session.add');
Route::post('session/create',[SessionController::class,'create'])->name('student.session.create');
// STUDENT
...
// ATTENDENCE
Route::get('attendence/view',[AttedenceController::class,'attendanceview'])->name('student.attendence.view');
// Route::get('attendence/add',[AttedenceController::class,'add'])->name('student.attendence.add');
Route::get('attendence/add/{id}',[AttedenceController::class,'add'])->name('student.attendence.adds');
Route::post('attendence/create',[AttedenceController::class,'store'])->name('student.attendence.create');
...
Route::get('changepassword',[UserProfileController::class,'changepassword'])->name('user.changepassword');
...
Route::get('/optimize', function() {
    ...
    return '<h1>Optimized cleared</h1>';
});